...
export declare class Replay implements Integration {
    ...
    private _replay?;
    constructor({ flushMinDelay, flushMaxDelay, stickySession, useCompression, sessionSampleRate, errorSampleRate, maskAllText, maskTextSelector, maskAllInputs, blockAllMedia, _experiments, blockClass, ignoreClass, maskTextClass, blockSelector, ..._recordingOptions }?: ReplayConfiguration);
